...
@section('content')
<form class="user" method="POST" action="{{ route('issue.store') }}">
    @csrf
    <div class="card">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        @foreach (config('params.tracker') as $id => $name)
                            <option value="{{ $id }}" {{ old("tracker") == $id ? "Selected" : "" }}>
                                {{ $name }}
                            </option>
                        @endforeach
                        </select>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="estimated_time" class="form-control" placeholder="Enter time in hours" value="{{ old('estimated_time') }}">
